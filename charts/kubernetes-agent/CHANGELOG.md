...
- 70d3d75: Forward merge from [2.52.0](#2520)
...
- 10c86c1: Forward merge from [2.51.1](#2511)

## 3.13.0

### Minor Changes

- 9e50171: Forward merge from [2.51.0](#2510)

## 3.12.0

### Minor Changes

- b80e5fc: Forward merge from [2.50.0](#2500)

## 3.11.0

### Minor Changes

- 384d6d1: Forward merge from [2.49.0](#2490)

## 3.10.0

### Minor Changes

- Forward merge from [2.48.0](#2480)
...
- 760faa4: Forward merge changes from [2.46.0](#2460)

## 3.7.0

### Minor Changes

- 717f43a: Forward merge changes from [2.45.0](#2450)
...
- 3e89462: Upgrade kubernetes-agent-tentacle to 9.2.4285
...
- f21f00a: Bumped Kubernetes Monitor version to 0.32.0
...
- e245d70: Upgrade kubernetes-agent-monitor to 0.30.0
