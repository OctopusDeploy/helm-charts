...
| scriptPods.proxies.http_proxy.host | string | `""` |  |
| scriptPods.proxies.http_proxy.password | string | `""` |  |
| scriptPods.proxies.http_proxy.port | int | `80` |  |
| scriptPods.proxies.http_proxy.username | string | `""` |  |
| scriptPods.proxies.https_proxy.host | string | `""` |  |
| scriptPods.proxies.https_proxy.password | string | `""` |  |
| scriptPods.proxies.https_proxy.port | int | `80` |  |
| scriptPods.proxies.https_proxy.username | string | `""` |  |
| scriptPods.proxies.no_proxy.hosts | list | `[]` |  |
