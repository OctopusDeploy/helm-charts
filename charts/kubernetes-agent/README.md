...
| agent.image | object | `{"pullPolicy":"IfNotPresent","repository":"octopusdeploy/kubernetes-agent-tentacle","tag":"8.3.2694","tagSuffix":""}` | The repository, pullPolicy, tag & tagSuffix to use for the agent image |
