...
| scriptPods.deploymentTarget.image.pullPolicy | string | `"IfNotPresent"` |  |
| scriptPods.deploymentTarget.image.repository | string | `""` |  |
| scriptPods.deploymentTarget.image.tag | string | `""` |  |
| scriptPods.worker.image.pullPolicy | string | `"IfNotPresent"` |  |
| scriptPods.worker.image.repository | string | `"octopusdeploy/worker-tools"` |  |
| scriptPods.worker.image.tag | string | `"ubuntu.22.04"` |  |
