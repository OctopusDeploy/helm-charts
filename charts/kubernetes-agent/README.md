...
| agent.image | object | `{"pullPolicy":"IfNotPresent","repository":"octopusdeploy/kubernetes-tentacle","tag":"8.1.1617"}` | The repository, pullPolicy & tag to use for the agent image |
