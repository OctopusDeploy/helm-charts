...
| agent.image | object | `{"pullPolicy":"IfNotPresent","repository":"octopusdeploy/kubernetes-agent-tentacle","tag":"9.2.4111","tagSuffix":""}` | The repository, pullPolicy, tag & tagSuffix to use for the agent image |
