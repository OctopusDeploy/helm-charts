...
This change only affects *new* installations of the Kubernetes agent that don't use a custom `ReadWriteMany` storage class.
...
1. Edit `overridden_values.yaml` in your editor of choice to move/add the fields specified above (and save!).

2. Upgrade your release to V2.0.0 of the helm-chart, applying your modified values
